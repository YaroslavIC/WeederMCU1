...
void WheelData::ReadAS5600(void) // pulling 0.5 ms
	...
	sumI[MAX_ANGLE_WHEEL_ARRAY - 1] = Current_Speed - Target_Speed;
...
void SetDir_Speed(float Speed, int Direction) {
